...
public class Menu : MonoBehaviourPunCallbacks, ILobbyCallbacks
{
    ...
    void Start()
    {
        // disable the nmenu buttons at the start
    ...
    //changes the currently visisble screen
    void SetScreen(GameObject screen)
    {
        //disable att other screens
        mainScreen.SetActive(false);
        createRoomScreen.SetActive(false);
        lobbyScreen.SetActive(false);
        lobbyBrowserScreen.SetActive(false);

        // activate teh requested screen
    ...
    // called whne the "Find Room" button has been pressed
    ...
    public void OnStartGameButton()
    {
        ...
        NetworkManager.instance.photonView.RPC("ChangeScene", RpcTarget.All, "Play");
    }
